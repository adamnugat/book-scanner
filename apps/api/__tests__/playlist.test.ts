...
const interstitial = {
  id: 'int-1',
  name: 'Soft chime',
  audioUrl: 'presets/soft-chime.mp3',
  durationMs: 2000,
};
...
describe('Playlist', () => {
  ...
  describe('GET /projects/:id/playlist', () => {
    it('T-7.2: returns playlist items with audio URLs', async () => {
      ...
      expect(res.body[0].audioUrl).toMatch(/\/projects\/proj-1\/audio-tracks\/at-1\/file\?token=/);
