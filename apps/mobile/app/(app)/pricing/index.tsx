      ...
      {usage && (
        <View style={styles.usageCard}>
          ...
          <Text style={styles.currentPlan}>
            Plan: <Text style={{ color: PLAN_COLORS[usage.plan] || '#888', fontWeight: 'bold' }}>{usage.plan.toUpperCase()}</Text>
          </Text>
...
const styles = StyleSheet.create({
  ...
  usageCard: { backgroundColor: '#16213e', borderRadius: 12, padding: 16, marginBottom: 24, borderWidth: 1, borderColor: '#0f3460' },
  ...
  activeBadge: { position: 'absolute', top: 12, right: 12, backgroundColor: '#e9456033', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
