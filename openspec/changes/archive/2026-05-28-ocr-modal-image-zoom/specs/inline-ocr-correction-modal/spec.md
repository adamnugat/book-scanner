...
Korekta tekstu OCR dla pojedynczego zdjęcia SHALL być prezentowana jako modal otwierany z ekranu zdjęć, a nie jako osobny ekran nawigacyjny. Modal MUST zawierać w górnej części zdjęcie z obsługą pinch-to-zoom i double-tap, a poniżej edytowalne pole tekstowe z tekstem utworzonym przez OCR oraz przycisk „Zapisz".
...
- **AND** modal MUST pokazać zdjęcie z możliwością zoomowania u góry oraz pole tekstowe z tekstem OCR poniżej
