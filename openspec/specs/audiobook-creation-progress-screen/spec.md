# Audiobook Creation Progress Screen

## Overview

Nakładka progresu kreatora automatycznego wyświetlana po kliknięciu "Utwórz audiobooka". Pokazuje trzy etapy przetwarzania (wgrywanie zdjęć → rozpoznawanie tekstu → generowanie audio) zgodnie z AudioFlow design system.
